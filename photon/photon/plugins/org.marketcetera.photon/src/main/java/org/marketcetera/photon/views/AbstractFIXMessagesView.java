 ...
 */
@ClassVersion("$Id: AbstractFIXMessagesView.java 16154 2012-07-14 16:34:05Z colin $")
        ...
        extends MessagesViewBase<ReportHolder>
{
     ...
     *
     * @author <a href="mailto:colin@marketcetera.com">Colin DuPlantis</a>
     * @version $Id: AbstractFIXMessagesView.java 16154 2012-07-14 16:34:05Z colin $
     * @since 0.7.0
     */
    @ClassVersion("$Id: AbstractFIXMessagesView.java 16154 2012-07-14 16:34:05Z colin $")//$NON-NLS-1$
